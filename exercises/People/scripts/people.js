...
const peopleListBody = document.querySelector("#peopleListBody");
...
function displayPeopleTable() {
  for (const person of people) {
    ...
    let personIp = person.ipAddress;

    let row = peopleListBody.insertRow();
    let cell1 = row.insertCell(0);
    cell1.innerText = personFirst;
    let cell2 = row.insertCell(1);
    cell2.innerText = personLast;
    let cell3 = row.insertCell(2);
    cell3.innerText = personEmail;
    let cell4 = row.insertCell(3);
    cell4.innerText = personIp;
  }
}

window.onload = displayPeopleTable;
